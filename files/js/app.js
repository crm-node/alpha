...
app.controller("calendarCtrl", ['$scope', '$rootScope', '$filter', '$q', '$timeout', '$log', 'MaterialCalendarData',
    function($scope, $rootScope, $filter, $q, $timeout, $log, MaterialCalendarData) {
